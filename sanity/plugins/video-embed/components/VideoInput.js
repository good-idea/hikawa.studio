...
import { SUPPORTED_SERVICES } from './VideoPreview'
...
// adapted from:
// https://github.com/sanity-io/sanity/blob/master/packages/example-studio/components/VideoEmbedInput/VideoEmbedInput.js
		...
		return (
			<FormField label={type.title} level={level} description={type.description}>
				...
				{result && (
					<div>
						Found a video
						<span role="img" aria-labelledby="Praise">
							🙌
						</span>
					</div>
				)}
